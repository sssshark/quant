...
| 国债时序动量（独立） | 1.51 | 3.1% | −4.4% | 第二策略（与 CTA 收益相关性 −0.099，股债跷跷板） |
| CTA + 国债 50/50（等权组合） | 1.37 | 7.4% | −6.2% | > 单 CTA（1.08），分散有效；部署默认 |
| CTA + 国债（risk-parity，月频可部署） | 1.50 | 5.2% | −5.3% | 对等权 1.37 **不显著**（P=0.182）；日频诊断上界 1.91（P=0.001）依赖全样本σ前视。默认仍等权 |
