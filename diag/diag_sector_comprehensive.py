...
设计:
  · 候选篮子 ~16 个行业 ETF,**先验按行业覆盖选**(消费/医药/金融/地产/军工/传媒/有色 +
    新经济:半导体/科技/新能源/新能源车/食品饮料/钢铁/计算机/通信/农业/新材料),绝不用收益挑。
...
# 注:515210 实为中证钢铁、516710 实为中证新材料(fund_basic benchmark 确认,
#     曾误标煤炭/光伏)。横截面选股结论不受影响(收益序列未变)。真测煤炭/光伏需换 515220/515790。
CANDIDATES = {
    ...
    "515170": "食品饮料", "515210": "钢铁", "512720": "计算机", "515880": "通信",
    "159825": "农业", "516710": "新材料", "159995": "芯片",
}
